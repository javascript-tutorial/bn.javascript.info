...
আপনি যদি এই জাতীয় স্ক্রিপ্টগুলি সম্পর্কে জানার পরিকল্পনা না করেন তবে আপনি এই অধ্যায়টি এড়িয়ে যেতে পারেন, তবে তা আপনাকে পরে সমসসায় ফেলতে পারে।

প্রথমদিকে দেখতে `var` এর আচরন `let` এর মতো হয়ে থাকে। সেটা হলো একটি ভেরিয়েবল ঘোষণা করাঃ 
...
অন্যভাবে বলা যায়, `var` ভেরিয়্যবলগুলো ফাংশনের শুরুতেই ঘোষিত হয়, সেটাকে যেখানেই সংজ্ঞায়িত করা হোক না কেন(ধরে নিলাম এটি কোন নেস্টেড ফাংশনের মধ্যে নয়)। 
...
কারন সকল `var` ফাংশনের শুরুতেই ঘোষিত হয়, আমরা যে কোনও জায়গায় তাদের রেফারেন্স করতে পারি। কিন্তু অ্যাসাইনমেন্টের আগ পর্যন্ত ভেরিয়্যবলগুলো আনডিফাইন থাকে। 
