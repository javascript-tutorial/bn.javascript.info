...
উদাহারণ হিসাবে , `alert` নিজে থেকেই ভ্যালুকে স্টিংয়ে রূপান্তর করে নেয়। অন্যদিকে, গানিতিক অপারেটরগুলি ভ্যালুকে সংখ্যায় রূপান্তর করে। 
...
কোন ভ্যালু থেকে স্টিং দরকার হলে স্টিং রূপান্তর করা হয়। 

উদাহরণ স্বরূপ, `alert(value)` একাজটি করে নেয় ভ্যালুটিকে দেখাতে।
...
প্রায় সব স্টিং রুপান্তর সুস্পষ্ট। এখানে, `false` হয়ে যায় `"false"`, `null` হয়ে যায় `"null"`, ইত্যাদি।
...
স্পট করে এই রুপান্তরের পন্থাটি তখনই কাজে লাগে, যখন এমন কোন সোর্স থেকে ভ্যালু পাই, যা স্টিং দেয় অথচ যেটাকে কোন সংখ্যায় দেয়ার কথা, যেমন ঃ টেক্সট ফর্ম ।
...
প্রায় সব গানিতিক অপারেটর ভ্যালুকে সংখ্যায় রূপান্তর করে নেয়। তবে উল্লেখযোগ্য একটি ব্যতিক্রম হলো যোগ `+`, যদি এর দুপাশের একটি ভ্যালুও স্টিং হয় তবে অপরটিও স্টিং হয়ে যাবে
...
এটা তখনই হয় যদি অন্তত একটি আর্গুমেন্ট স্টিং থাকে, নাহয় তা সংখ্যায় রুপান্তরিত হয়ে যাবে।
````
...
বহুল ব্যাবহৃত ৩টি রূপান্তরসমূহ হচ্ছে স্টিংয়ে,সংখ্যায়, বুলিয়ানে। 

**`স্টিংয়ে রূপান্তর`** -- আউটপুট দেখতে হলে হয়। অথবা `String(value)` দিয়ে করা যায়। প্রায় সব মৌলিক ভ্যালুর জন্য এটা খুব স্পষ্ট।
