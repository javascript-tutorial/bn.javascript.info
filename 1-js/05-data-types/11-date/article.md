...
এই অধ্যায়ে আমরা নতুন আরেকটি বিল্ট-ইন অবজেক্ট [Date](mdn:js/Date) সম্পর্কে জানব। এর সাহায্যে আমরা তারিখ/সময় এর বিভিন্ন মেথড নিয়ে কাজ করতে পারব।

যেমন, আমরা কোন ডাটা তৈরির বা পরিবর্তন এর সময় সংরক্ষণ করতে পারি, অথবা বর্তমান সময় বা তারিখ জানার জন্যও ব্যবহার করতে পারি।
...
: স্থানীয় সময়মান হিসেবে `Date` অবজেক্ট তৈরীর জন্য আমরা উপরের নিয়ম অনুযায়ী কল করতে পারি, এক্ষেত্রে প্রথম দুটি আর্গুমেন্ট অবশ্যই দিতে হবে, শুধুমাত্র একটি আর্গুমেন্ট পাঠালে এটি টাইমস্ট্যাম্প হিসেবে ধরে নিবে।

    - `year` অবশ্যই পূর্ণভাবে লিখতে হবে: `2013` সঠিক, `98` সঠিক নয়।
...
এছাড়াও, আমরা সপ্তাহের নাম ও জানতে পারি:
...
মনে করুন আমরা "28 ফেব্রুয়ারী 2016" এর সাথে ২দিন যোগ করব, এক্ষেত্রে এটি অধিবর্ষের(লিপ ইয়ার) জন্য "২রা মার্চ" অথবা "১লা মার্চ" হতে পারে। আমাদের এ ব্যাপারে চিন্তা করতে হবে না, কেননা `Date` স্বয়ংক্রিয়ভাবে এটি ব্যবস্থা নিতে পারে:
...
এই ফিচারটি আমরা একটি নির্দিষ্ট সময়ের পরের সময়টি জানতে কাজে আসে, মনে করুন আমরা "বর্তমান সময়ের 70 সেকেন্ড পরের সময়টি" জানতে চাই:
...
আমরা এটি সময় পরিমাপের জন্য ব্যবহার করি:
