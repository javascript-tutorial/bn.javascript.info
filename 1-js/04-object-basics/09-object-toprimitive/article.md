...
দুটি অবজেক্টের মধ্যে যোগ `obj1 + obj2`, বিয়োগ `obj1 - obj2` বা অবজেক্টকে প্রিন্ট করার সময় `alert(obj)` কী ঘটে?

এইক্ষেত্রে, অবজেক্ট শুরুতে প্রিমিটিভ ভ্যালুতে রূপান্তর হয়, এবং তারপর এদের মধ্যের অপারেশন গুলো সংগঠিত হয়।

এই অধ্যায়ে <info:type-conversions> আমরা স্ট্রিং, বুলিয়ানর এবং সাংখ্যিক রূপান্তরের নিয়ম দেখেছি। তবে অবজেক্ট নিয়ে আলোচনা করা হয়নি। ইতোমধ্যে যেহেতু আমরা সিম্বল এবং মেথড সম্পর্কে পড়েছি সুতরাং আমরা অবজেক্ট রূপান্তর নিয়ে জানতে পারব।
...
3. সাধারণত স্ট্রিংয়ের রূপান্তর ঘটে যখন আমরা কোন অবজেক্টের মান দেখাতে চাই যেমন `alert(obj)` অথবা এই ধরণের অন্যান্য কাজে।

## ToPrimitive

আমরা স্ট্রিং এবং সাংখ্যিক রূপান্তরকে বিশেষ অবজেক্ট মেথডের সাহায্যে নিয়ন্ত্রন করতে পারি।

৩ ধরণের টাইপ কাস্টিং আছে , যাদের বলা হয় "hints", এখানে বিস্তারিত আলোচনা করা হয়েছে [specification](https://tc39.github.io/ecma262/#sec-toprimitive):

`"string"`
: অবজেক্ট হতে স্ট্রিংয়ে রূপান্তরের জন্য, যখন আমরা এমন কোন অপারেশন এক্সিকিউট যেটি মান হিসেবে স্ট্রিং নেয়, যেমন `alert` বা অবজেক্টের প্রপার্টির নাম:

    ```js
    // output
    alert(obj);

    // স্ট্রিং হিসেবে সেট হবে
    anotherObj[obj] = 123;
    ```
...
: যখন অপারেশনটি কী ধরনের মান আশা করে এ ব্যাপারে নিশ্চিত নই।
    ...
    যেমন বাইনারি যোগ `+` অপারেশনের জন্য এটি স্ট্রিং কনক্যাটেনেশন এবং যোগ উভয় করার জন্য ব্যবহার করা হয়, সুতরাং এটি স্ট্রিং বা নাম্বার যেকোনটার জন্য কাজ করে। সুতরাং যখন বাইনারি যোগ একটি অবজেক্টকে আর্গুমেন্ট হিসেবে নেয়, এটি `"default"` হিন্ট হিসেবে কনভার্ট হয়।
    ...
    তবে প্রাত্যহিক কাজে, আমাদের এই সূক্ষ্ণ ব্যাপারগুলো এত বিশদ মনে রাখার কোন দরকার নেই, কেননা সকল বিল্ট-ইন অবজেক্ট শুধুমাত্র because all built-in objects except for one case (`Date` object, we'll learn it later) implement `"default"` conversion the same way as `"number"`. And we can do the same.
...
obj[Symbol.toPrimitive] = function(hint) {
  // অবশ্যই একটি প্রিমিটিভ ভ্যালু রিটার্ন করে
  // hint হতে পারে "string", "number", "default"
};
```
...
ডিফল্টভাবে, একটি অবজেক্ট এভাবে কাজ করে প্রথমে `toString` কল হবে তারপর `valueOf` মেথড:
...
যেমন, এখানে `user` এর জন্য `Symbol.toPrimitive` এর পরিবর্তে `toString` এবং `valueOf` ইমপ্লিমেন্ট করি:
