...
তো আমাদের এটি করতে যেসব ক্যারাক্টার "ডিজিট বা অঙ্ক" নয় তাদের বাদ দিতে হবে। ক্যারাক্টার ক্লাসের সাহায্যে আমরা এটি করতে পারি।

*ক্যারাক্টার ক্লাস* হল একটি বিশেষ চিহ্ন বা বর্ণ যা দ্বারা কোন একটি নির্দিষ্ট সেটের যেকোন সিম্বলকে নির্দেশ করে।
...
: স্পেস সিম্বল হল: স্পেসসহ, ট্যাব `\t`, নিউলাইন `\n` এছাড়াও কিছু বিরল ক্যারাক্টার আছে, যেমন: `\v`, `\f` এবং `\r`।

`pattern:\w` ("w" দ্বারা বুঝায় "word" বা বর্ণ)
: "wordly" ক্যারাক্টার হল: লাতিন বর্ণমালার বর্ণ বা অঙ্ক বা আন্ডারস্কোর `_`। নন-লাতিন বর্ণ (যেমন হিন্দি বা বাংলা) বর্ণগুলো `pattern:\w` দ্বারা বুঝায় না।

উদাহরণস্বরূপ, `pattern:\d\s\w` দ্বারা বুঝায় একটি "অঙ্ক" একটি "স্পেস ক্যারাক্টার" একটি "বর্ণ ক্যারাক্টার" যেমন: `match:1 a`।

**রেগুলার এক্সপ্রেশনে রেগুলার সিম্বল এবং ক্যারাক্টার ক্লাসের সিম্বল একসাথে থাকতে পারে।**
...
একইভাবে আমরা অনেক ক্যারাক্টার ক্লাসের মাধ্যমেও চেক করতে পারি:

```js run
alert( "I love HTML5!".match(/\s\w\w\w\w\d/) ); // ' HTML5'
```

মিলটিতে (প্রতিটি রেগুলার এক্সপ্রেশন ক্যারাক্টার ক্লাস রেজাল্টের ক্যারাক্টারগুলোর সাথে মিলে):

![](love-html5-classes.svg)

## ইনভার্স ক্লাস

প্রতিটি ক্যারাক্টার ক্লাসের আবার একটি "ইনভার্স ক্লাস" আছে, তবে এদের বড় হাতের অক্ষর দিয়ে প্রকাশ করা হয়।

ইনভার্স ক্লাস দ্বারা বুঝানো হয় এটি দ্বারা অন্যান্য ক্যারাক্টারগুলোর সাথে মিলবে, উদাহরণস্বরূপ:

`pattern:\D`
: নন-ডিজিট: `pattern:\d` বাদে অন্যান্য ক্যারাক্টার। উদাহরণস্বরূপ, বর্ণমালা।

`pattern:\S`
: নন-স্পেস: `pattern:\s` বাদে অন্যান্য ক্যারাক্টার। উদাহরণস্বরূপ, বর্ণমালা।

`pattern:\W`
: নন-ওয়ার্ডলি ক্যারাক্টার: `pattern:\w` বাদে অন্যান্য ক্যারাক্টার, যেমন: লাতিন বর্ণমালা বা স্পেস বাদে অন্যান্যসমূহ।
...
## ডট দ্বারা "যেকোন ক্যারাক্টার" বুঝায়

ডট `pattern:.` হল একটি বিশেষ ক্যারাক্টার যা দ্বারা নিউলাইন `\n` ব্যতীত সকল ক্লাসকে বুঝার।
...
রেগুলার এক্সপ্রেশনের মধ্যের কোন ক্যারাক্টারকে বুঝাতে:
...
অনুগ্রহ করে মনে রাখবেন যদিও ডট দ্বারা "যেকোন ক্যারাক্টার" বুঝায়, কিন্ত "ক্যারাক্টারের অনুপস্থিতি বা শূণ্যস্থান" কে বুঝায় না। মিলের জন্য অবশ্যই একটি ক্যারাক্টার থাকা লাগবে:

```js run
alert( "CS4".match(/CS.4/) ); // null, কেননা ডট দ্বারা বুঝাতে কোন ক্যারাক্টার নাই
```

### s ফ্ল্যাগের সাথে ডট হল যেকোন ক্যারাক্টার

ডিফল্টভাবে ডট নিউলাইন ক্যারাক্টারের `\n` সাথে মিলেনা।

উদাহরণস্বরূপ, `pattern:A.B` এই রেগুলার এক্সপ্রেশটি প্রথমে `match:A` এবং `match:B` এর মাঝে নিউলাইন `\n` ব্যতীত অন্য কোন ক্যারাক্টার থাকলে মিলবে:

```js run
alert( "A\nB".match(/A.B/) ); // null (no match)
```

অনেক সময় আমাদের ডট দ্বারা নিউলাইনসহ যেকোন ক্যারাক্টারকে বুঝাতে হয়।

`pattern:s` ফ্ল্যাগের সাহায্যে এটি আমরা করতে পারি। যদি রেগুলার এক্সপ্রেশনে এটি থাকে তাহলে ডট `pattern:.` যেকোন ক্যারাক্টারের সাথে মিলে:
...
আমরা রেগুলার এক্সপ্রেশনে এভাবেও `pattern:[\s\S]` ব্যবহার করতে পারি যা "যেকোন ক্যরাক্টারের" সাথে মিলে।

```js run
alert( "A\nB".match(/A[\s\S]B/) ); // A\nB (match!)
```

`pattern:[\s\S]`-টি দ্বারা আক্ষরিক অর্থে বুঝানো হচ্ছে "একটি স্পেস ক্যারাক্টার অথবা স্পেস ক্যারাক্টার নয়"। অন্য অর্থে, "যেকোন কিছু"। এর পরিবর্তে আমরা এভাবেও করতে পারি `pattern:[\d\D]`।
...
**স্পেসও একটি ক্যারাক্টার। এটি অন্যান্য ক্যারাক্টারের মত গুরুত্বপূর্ণ।**

রেগুলার এক্সপ্রেশনে স্পেস যোগ বা বাদ দিয়ে সঠিকভাবে কাজ করবে আমরা এই আশা করতে পারিনা।

অন্য অর্থে বলা যায়, রেগুলার এক্সপ্রেশনে স্পেসসহ প্রতিটি ক্যারাক্টার তাৎপর্যপূর্ণ।
````

## সারাংশ

রেগুলার এক্সপ্রেশনে নিম্নোক্ত ক্যারাক্টার ক্লাসগুলো আছে:
...
ইউনিকোড এনকোডিং, জাভাস্ক্রিপ্টে স্ট্রিংয়ে অন্যান্য বিভিন্ন ক্যারাক্টার যেমনঃ অন্যান্য ভাষার বর্ণ বা চিহ্ন ইত্যাদি ব্যবহৃত হয়।
